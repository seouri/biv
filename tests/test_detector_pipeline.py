...
class TestDetectorPipeline:
    ...
    def test_tc006_detector_pipeline_or_combination(self) -> None:
        flags_df = [
    ...
    def test_tc007_detector_pipeline_and_combination(self) -> None:
        flags_df = [
    ...
    def test_tc008_detector_pipeline_raises_keyerror_for_invalid_logic(self) -> None:
        with pytest.raises(KeyError, match="Unsupported combination logic 'XOR'"):
            DetectorPipeline(logic="XOR")

    def test_tc009_detector_pipeline_handles_empty_flags_list(self) -> None:
        pipeline = DetectorPipeline(logic="OR")
        result = pipeline.combine_flags([])
        assert result == {}

    def test_tc010_detector_pipeline_multiple_columns_or_logic(self) -> None:
        flags_df = [
    ...
    def test_tc011_detector_pipeline_multiple_columns_and_logic(self) -> None:
        flags_df = [
