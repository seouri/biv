...
class TestDetectorPipeline:
    ...
    def test_tc038_detector_pipeline_handles_empty_flags_list(self) -> None:
        pipeline = DetectorPipeline(logic="OR")
        result = pipeline.combine_flags([])
        assert result == {}

    def test_tc039_detector_pipeline_multiple_columns_or_logic(self) -> None:
        flags_df = [
    ...
    def test_tc040_detector_pipeline_multiple_columns_and_logic(self) -> None:
        flags_df = [
