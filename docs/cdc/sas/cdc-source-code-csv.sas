...
***********************************************************************;
*** BEGIN MODIFICATION: READ CDCref_d.csv INSTEAD OF CDCref_d.sas7bdat
***********************************************************************;

*** 1. IMPORT THE CSV FILE ***;
PROC IMPORT DATAFILE="&dirpath/CDCref_d.csv"
    OUT=refdir.CDCref_d_csv
    DBMS=CSV
    REPLACE;
    GETNAMES=YES;
    GUESSINGROWS=MAX;
...
*** 2. CREATE CDCref_d DATASET WITH CORRECT VARIABLE TYPES ***;
data refdir.CDCref_d;
    set refdir.CDCref_d_csv;
    _LHT1 = input(_LHT1, best32.);
    _MHT1 = input(_MHT1, best32.);
    _SHT1 = input(_SHT1, best32.);
    _LHT2 = input(_LHT2, best32.);
    _MHT2 = input(_MHT2, best32.);
    _SHT2 = input(_SHT2, best32.);
    _LBMI1 = input(_LBMI1, best32.);
    _MBMI1 = input(_MBMI1, best32.);
    _SBMI1 = input(_SBMI1, best32.);
    _LBMI2 = input(_LBMI2, best32.);
    _MBMI2 = input(_MBMI2, best32.);
    _SBMI2 = input(_SBMI2, best32.);
    _LG1 = input(_LG1, best32.);
    _LWLG1 = input(_LWLG1, best32.);
    _MWLG1 = input(_MWLG1, best32.);
    _SWLG1 = input(_SWLG1, best32.);
    _LG2 = input(_LG2, best32.);
    _LWLG2 = input(_LWLG2, best32.);
    _MWLG2 = input(_MWLG2, best32.);
    _SWLG2 = input(_SWLG2, best32.);
    _HT1 = input(_HT1, best32.);
    _LWHT1 = input(_LWHT1, best32.);
    _MWHT1 = input(_MWHT1, best32.);
    _SWHT1 = input(_SWHT1, best32.);
    _HT2 = input(_HT2, best32.);
    _LWHT2 = input(_LWHT2, best32.);
    _MWHT2 = input(_MWHT2, best32.);
    _SWHT2 = input(_SWHT2, best32.);
    _htcat = input(_htcat, best32.);
run;
